...
{
    public static class SeaExperimentalSteps
    {
        ...
        public static readonly ulong DefaultSeedA = Seeder.GetNewSeed<ulong>();
        public static readonly ulong DefaultSeedB = Seeder.GetNewSeed<ulong>();
        public static readonly ulong DefaultSeedC = Seeder.GetNewSeed<ulong>();
        public static readonly ulong DefaultSeedD = Seeder.GetNewSeed<ulong>();
        ...
        public static void MixFinalPartialStep(ref ulong a, ref ulong b, ulong block1, ulong block2)
        {
            ...
            a *= 0x6eed0e9da4d94a4fUL;
            b *= 0x6eed0e9da4d94a4fUL;
