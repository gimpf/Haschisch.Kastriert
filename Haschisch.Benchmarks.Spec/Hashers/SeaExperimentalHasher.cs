...
{
    public static class SeaExperimentalHasher
    {
        public struct Block :
            IBlockHasher<int>,
            IBlockHasher<long>,
            ...
            IUnsafeBlockHasher<long>
        {
            ...
            public long Hash(ref byte data, int length)
            {
                ...
                SeaExperimentalSteps.InitializeForTestVectors(out var a, out var b, out var c, out var d);

                var indexFullBlockEnd = length & ~(SeaExperimentalSteps.FullBlockSize - 1);
                ...
                for (var i = 0; i < indexFullBlockEnd; i += SeaExperimentalSteps.FullBlockSize)
                {
                    ...
                    SeaExperimentalSteps.MixStep(ref ia, ref ib, ref ic, ref id, x0, x1, x2, x3);
                }
                ...
                {
                    var x0 = Unsafe.As<byte, ulong>(ref Unsafe.Add(ref data, i));
                    SeaExperimentalSteps.MixStep(ref a, ref b, ref c, ref d, x0);
                }

                if (indexFullWordEnd != length)
                {
                    SeaExperimentalSteps.MixStep(
                        ref a,
                        ref b,
                        ref c,
                        ref d,
                ...
                return (long)SeaExperimentalSteps.Finish(ref a, ref b, ref c, ref d, (uint)length);
            }
        }
        ...
        public struct Stream : IStreamingHasher<long>, IStreamingHasher<int>
        {
            ...
            public unsafe int UnsafeWrite(ref byte data, int maxLength)
            {
                ...
                var indexFullBlockEnd = maxLength & ~(SeaExperimentalSteps.FullBlockSize - 1);
            ...
            public void Initialize()
            {
                this.bufferIdx = 0;
                this.length = 0;
                SeaExperimentalSteps.InitializeForTestVectors(out this.a, out this.b, out this.c, out this.d);
            }
            ...
            public long Finish()
            {
                unchecked
                {
                    ...
                    return (long)SeaExperimentalSteps.Finish(ref this.a, ref this.b, ref this.c, ref this.d, this.length);
                }
            }
            ...
            {
                SeaExperimentalSteps.MixStep(ref this.a, ref this.b, ref this.c, ref this.d, this.buffer);
        ...
        public struct Combiner : IHashCodeCombiner
        {
            ...
            public int Combine<T1>(T1 value1)
            {
                ...
                SeaExperimentalSteps.Initialize(out var a, out var b, out var c, out var d);
                SeaExperimentalSteps.MixFinalPartialStep(ref a, (uint)v1);
                return (int)SeaExperimentalSteps.Finish(ref a, ref b, ref c, ref d, sizeof(int));
            }
            ...
            public int Combine<T1, T2>(T1 value1, T2 value2)
            {
                ...
                SeaExperimentalSteps.Initialize(out var a, out var b, out var c, out var d);
                SeaExperimentalSteps.MixFinalPartialStep(ref a, ((uint)v2 << 32) | (uint)v1);
                return (int)SeaExperimentalSteps.Finish(ref a, ref b, ref c, ref d, 2 * sizeof(int));
            }
            ...
            public int Combine<T1, T2, T3>(T1 value1, T2 value2, T3 value3)
            {
                ...
                SeaExperimentalSteps.Initialize(out var a, out var b, out var c, out var d);
                SeaExperimentalSteps.MixFinalPartialStep(
                    ref a,
                    ref b,
                    v1 | ((ulong)v2 << 32),
                    v3);
                return (int)SeaExperimentalSteps.Finish(ref a, ref b, ref c, ref d, 3 * sizeof(int));
            }
            ...
            public int Combine<T1, T2, T3, T4>(T1 value1, T2 value2, T3 value3, T4 value4)
            {
                ...
                SeaExperimentalSteps.MixFinalPartialStep(
                    ...
                    (uint)v1 | ((ulong)v2 << 32),
                    (uint)v3 | ((ulong)v4 << 32));
                return (int)SeaExperimentalSteps.Finish(ref a, ref b, ref c, ref d, 4 * sizeof(int));
            }
            ...
            public int Combine<T1, T2, T3, T4, T5>(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5)
            {
                ...
                SeaExperimentalSteps.MixFinalPartialStep(
                    ...
                    (uint)v3 | ((ulong)v4 << 32),
                    (uint)v5);
                return (int)SeaExperimentalSteps.Finish(ref a, ref b, ref c, ref d, 5 * sizeof(int));
            }
                ...
                T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6)
            {
                ...
                SeaExperimentalSteps.MixFinalPartialStep(
                    ...
                    (uint)v3 | ((ulong)v4 << 32),
                    (uint)v5 | ((ulong)v6 << 32));
                return (int)SeaExperimentalSteps.Finish(ref a, ref b, ref c, ref d, 6 * sizeof(int));
            }
                ...
                T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7)
            {
                ...
                SeaExperimentalSteps.MixStep(
                    ...
                    (uint)v5 | ((ulong)v6 << 32),
                    (uint)v7);
                return (int)SeaExperimentalSteps.Finish(ref a, ref b, ref c, ref d, 7 * sizeof(int));
            }
                ...
                T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7, T8 value8)
            {
                ...
                SeaExperimentalSteps.MixStep(
                    ...
                    (uint)v5 | ((ulong)v6 << 32),
                    (uint)v7 | ((ulong)v8 << 32));
                return (int)SeaExperimentalSteps.Finish(ref a, ref b, ref c, ref d, 8 * sizeof(int));
            }
        }
    }
}
