...
namespace Haschisch.Benchmarks
{
        ...
        where THasher : IUnsafeBlockHasher<int>
    {
        ...
        {
            var h = new PackedList<int, int, int, int, int>(
                value1?.GetHashCode() ?? 0,
                value2?.GetHashCode() ?? 0,
                value3?.GetHashCode() ?? 0,
                value4?.GetHashCode() ?? 0,
            ...
            return default(THasher).Hash(
                ref Unsafe.As<PackedList<int, int, int, int, int>, byte>(ref h),
                5 * sizeof(int));
        }
        ...
        {
            var h = new PackedList<int, int, int, int, int, int>(
                value1?.GetHashCode() ?? 0,
                value2?.GetHashCode() ?? 0,
                value3?.GetHashCode() ?? 0,
                value4?.GetHashCode() ?? 0,
            ...
            return default(THasher).Hash(
                ref Unsafe.As<PackedList<int, int, int, int, int, int>, byte>(ref h),
                6 * sizeof(int));
        }
        ...
        {
            var h = new PackedList<int, int, int, int, int, int, int>(
                value1?.GetHashCode() ?? 0,
                value2?.GetHashCode() ?? 0,
                value3?.GetHashCode() ?? 0,
                value4?.GetHashCode() ?? 0,
            ...
            return default(THasher).Hash(
                ref Unsafe.As<PackedList<int, int, int, int, int, int, int>, byte>(ref h),
                7 * sizeof(int));
        }
