...
{
    public class HashByteArray_CompareMarvin32
    {
        private byte[] data;
        ...
        [Benchmark]
        public int Marvin32_Stream()
        {
            return HashByteArrayUtil.HashWithStreaming<Marvin32Hasher.Stream>(this.data);
        }

        [Benchmark]
        public int Marvin32_Stream_ByU32()
        {
            return HashByteArrayUtil.HashWithStreamingByBlockedU32Unsafe<Marvin32Hasher.Stream>(this.data);
        }
    }
}
