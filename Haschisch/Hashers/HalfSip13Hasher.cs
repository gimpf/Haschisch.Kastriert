    ...
    public static class HalfSip13Hasher
    {
        ...
        public struct Combiner : IHashCodeCombiner
        {
            ...
            public int Combine<T1, T2, T3>(T1 value1, T2 value2, T3 value3)
            {
                ...
                HalfSip13Steps.Initialize(DefaultKey, out var v0, out var v1, out var v2, out var v3);
                HalfSip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, x1);
                HalfSip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, x2);
                HalfSip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, x3);
                return HalfSip13Steps.Finish(ref v0, ref v1, ref v2, ref v3, 0, 3 * sizeof(int));
            }
                ...
                T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6)
            {
                ...
                return HalfSip13Steps.Finish(ref v0, ref v1, ref v2, ref v3, 0, 6 * sizeof(int));
            }
                ...
                T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7)
            {
                ...
                return HalfSip13Steps.Finish(ref v0, ref v1, ref v2, ref v3, 0, 7 * sizeof(int));
            }
