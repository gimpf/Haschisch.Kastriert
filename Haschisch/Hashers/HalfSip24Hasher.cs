    ...
    public static class HalfSip24Hasher
    {
            ...
            ISeedableBlockHasher
        {
            ...
            private static int Hash((uint, uint) seed, ref byte data, int length)
            {
                ...
                {
                    HalfSip24Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, Unsafe.As<byte, uint>(ref Unsafe.Add(ref data, i)));
                }

                return HalfSip24Steps.Finish(
        ...
        public struct Combiner : IHashCodeCombiner
        {
                ...
                T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6)
            {
                ...
                return HalfSip24Steps.Finish(ref v0, ref v1, ref v2, ref v3, 0, 6 * sizeof(int));
            }
                ...
                T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7)
            {
                ...
                return HalfSip24Steps.Finish(ref v0, ref v1, ref v2, ref v3, 0, 7 * sizeof(int));
            }
