    ...
    public static class Sip13Hasher
    {
            ...
            ISeedableBlockHasher
        {
            ...
            private unsafe long Hash((ulong, ulong) seed, ref byte data, int length)
            {
                ...
                {
                    Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, Unsafe.As<byte, ulong>(ref Unsafe.Add<byte>(ref data, i)));
                }
        ...
        public struct Combiner : IHashCodeCombiner
        {
            ...
            public int Combine<T1, T2, T3>(T1 value1, T2 value2, T3 value3)
            {
                ...
                Sip13Steps.Initialize(DefaultSeed, out var v0, out var v1, out var v2, out var v3);
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, x1 | (ulong)x2 << 32);
                return (int)Sip13Steps.Finish(ref v0, ref v1, ref v2, ref v3, (uint)x3, 3 * sizeof(int));
            }
                ...
                T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6)
            {
                ...
                return (int)Sip13Steps.Finish(ref v0, ref v1, ref v2, ref v3, 0, 6 * sizeof(int));
            }
                ...
                T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7)
            {
                ...
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, (uint)x3 | (ulong)x4 << 32);
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, (uint)x5 | (ulong)x6 << 32);
                return (int)Sip13Steps.Finish(ref v0, ref v1, ref v2, ref v3, (uint)x7, 7 * sizeof(int));
            }
