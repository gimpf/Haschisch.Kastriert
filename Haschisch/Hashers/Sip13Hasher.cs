...
{
    public static class Sip13Hasher
    {
            ...
            ISeedableBlockHasher
        {
            ...
            {
                Sip13Steps.Initialize(seed, out var v0, out var v1, out var v2, out var v3);
                ...
                {
                    Sip13Steps.SipCRound(ref pv0, ref pv1, ref pv2, ref pv3, Unsafe.As<byte, ulong>(ref Unsafe.Add(ref data, i)));
                    Sip13Steps.SipCRound(ref pv0, ref pv1, ref pv2, ref pv3, Unsafe.As<byte, ulong>(ref Unsafe.Add(ref data, i + sizeof(ulong))));
                    Sip13Steps.SipCRound(ref pv0, ref pv1, ref pv2, ref pv3, Unsafe.As<byte, ulong>(ref Unsafe.Add(ref data, i + (2 * sizeof(ulong)))));
                    Sip13Steps.SipCRound(ref pv0, ref pv1, ref pv2, ref pv3, Unsafe.As<byte, ulong>(ref Unsafe.Add(ref data, i + (3 * sizeof(ulong)))));
                }

                for (var i = bigBlockEnd; i < fullBlockEnd; i += sizeof(ulong))
                {
                    Sip13Steps.SipCRound(ref pv0, ref pv1, ref pv2, ref pv3, Unsafe.As<byte, ulong>(ref Unsafe.Add<byte>(ref data, i)));
                }
            ...
            ISeedableStreamingHasher<int, (ulong, ulong)>
        {
            ...
            public void Initialize((ulong, ulong) seed)
            {
                this.bufferIdx = 0;
                this.length = 0;
                Sip13Steps.Initialize(seed, out this.v0, out this.v1, out this.v2, out this.v3);
            }
            ...
            public long Finish()
            {
                ...
                return Sip13Steps.Finish(ref this.v0, ref this.v1, ref this.v2, ref this.v3, this.buffer, this.length);
            }
            ...
            {
                Sip13Steps.SipCRound(ref this.v0, ref this.v1, ref this.v2, ref this.v3, this.buffer);
                this.length += 8;
                this.bufferIdx = 0;
            }
        }
        ...
        public struct Combiner : IHashCodeCombiner
        {
            public int Combine<T1>(T1 value1)
            {
                ...
                Sip13Steps.Initialize(DefaultSeed, out var v0, out var v1, out var v2, out var v3);
                return (int)Sip13Steps.Finish(ref v0, ref v1, ref v2, ref v3, (uint)x1, sizeof(int));
            }
            ...
            public int Combine<T1, T2>(T1 value1, T2 value2)
            {
                ...
                Sip13Steps.Initialize(DefaultSeed, out var v0, out var v1, out var v2, out var v3);
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, (uint)x1 | (ulong)x2 << 32);
                return (int)Sip13Steps.Finish(ref v0, ref v1, ref v2, ref v3, 0, 2 * sizeof(int));
            }
            ...
            public int Combine<T1, T2, T3, T4>(T1 value1, T2 value2, T3 value3, T4 value4)
            {
                ...
                Sip13Steps.Initialize(DefaultSeed, out var v0, out var v1, out var v2, out var v3);
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, (uint)x1 | (ulong)x2 << 32);
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, (uint)x3 | (ulong)x4 << 32);
                return (int)Sip13Steps.Finish(ref v0, ref v1, ref v2, ref v3, 0, 4 * sizeof(int));
            }
            ...
            public int Combine<T1, T2, T3, T4, T5>(T1 value1, T2 value2, T3 value3, T4 value4, T5 value5)
            {
                ...
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, (uint)x1 | (ulong)x2 << 32);
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, (uint)x3 | (ulong)x4 << 32);
                return (int)Sip13Steps.Finish(ref v0, ref v1, ref v2, ref v3, (uint)x5, 5 * sizeof(int));
            }
                ...
                T1 value1, T2 value2, T3 value3, T4 value4, T5 value5, T6 value6, T7 value7, T8 value8)
            {
                ...
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, (uint)x1 | (ulong)x2 << 32);
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, (uint)x3 | (ulong)x4 << 32);
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, (uint)x5 | (ulong)x6 << 32);
                Sip13Steps.SipCRound(ref v0, ref v1, ref v2, ref v3, (uint)x7 | (ulong)x8 << 32);
                return (int)Sip13Steps.Finish(ref v0, ref v1, ref v2, ref v3, 0, 8 * sizeof(int));
            }
        }
